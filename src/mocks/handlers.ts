...
export const handlers = [
  rest.get(`${baseURL}/v2/titlelist`, (req, res, ctx) => {
    const data = [
      {
        id: 'TestPostData2',
        title: 'From MSW: 2022年のテスト投稿',
        release: true,
        createDate: '1641320641000',
      },
      {
        id: 'D10nUA0mnIUnzRNAL9tx',
        title: 'From MSW: 画像投稿テスト',
        release: false,
        createDate: '1641771785795',
      },
      {
        id: 'PrivatePostData',
        title: 'From MSW: 準備中の記事',
        release: false,
        createDate: '1640872405123',
      },
      {
        id: 'FynE3JpxYWPSqboszEA2',
        title: 'From MSW: SWR の useSWRImmutable を使う',
        release: true,
        createDate: '1634656164684',
      },
      {
        id: 'TestPostData1',
        title: 'From MSW: 2020年のテスト投稿',
        release: true,
        createDate: '1604203113000',
      },
      {
        id: 'YrtBam2iH0XUNB4ucQVU',
        title: 'From MSW: ブログをリリースしました',
        release: true,
  ...
  rest.get(`${baseURL}/v2/post/:postId`, (req, res, ctx) => {
  ...
  rest.post(`${baseURL}/v2/post/updatepost/:documentPath`, (req, res, ctx) => {
    if (isObjectEmpty(req.body)) {
      return res(
        ctx.status(400),
        ctx.json({
  ...
  rest.post(`${baseURL}/v2/post/deletepost/:documentPath`, (req, res, ctx) => {
    const { documentPath } = req.params;
